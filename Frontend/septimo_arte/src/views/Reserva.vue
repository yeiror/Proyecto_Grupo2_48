      ...
      <v-container class="fill-height" fluid>
        <v-row align="center" justify="center">
          <v-col cols="12" sm="8" md="9">
            <v-card class="mx-auto" max-width="500" elevation="12" dark>
              <v-card-title
                ...
                <v-window-item :value="2">
                  <v-card flat color="transparent">
                    <v-card-text>
                      ...
                      <span class="text-caption grey--text text--darken-1">
                        Selecciona la cantidad de boletas a reservar
                      </span>
                    </v-card-text>
                    <v-card-text>
                      <v-chip-group
                ...
                <v-window-item :value="4">
                  <div class="pa-4 text-center">
                    <v-img
                      ...
                      contain
                      height="128"
                      :src="require('@/assets/logos/02.logo.png')"
                      alt="logo"
                    ></v-img>
                    ...
                    <span class="text-caption grey--text"
                      >Gracias por divertirte con septimo arte!</span
                    >
                  </div>
                </v-window-item>
              </v-window>
